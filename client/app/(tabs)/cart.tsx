...
export default function CarrinhoProdutos() {
  const { produtos, alterarQuantidade, limparCarrinho } = useCart();
  ...
  const valorTotal = produtos.reduce((total, produto) => total + produto.preco * produto.quantidade, 0).toFixed(2);
      ...
      <View style={styles.container}>
        ...
        {produtos.length > 0 && (
          <Pressable
            ...
            style={({ pressed }) => [styles.botaoLimpar, pressed && styles.botaoPressionado]}
          >
            <Text style={styles.botaoLimparTexto}>Limpar Carrinho</Text>
          </Pressable>
        )}
        ...
        <View style={styles.inputContainer}>
          ...
          <View style={styles.rowInput}>
            ...
            />
            <Pressable
              style={({ pressed }) => [styles.botaoFlex, pressed && styles.botaoPressionado]}
        ...
        <Pressable
          ...
          style={({ pressed }) => [styles.botaoFinal, pressed && styles.botaoPressionado]}
        >
